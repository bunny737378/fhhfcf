  ...
  for (let i = 0; i < count; i++) {
    ...
    try {
      ...
      if (info && info.guest_account_info) {
        ...
        // Extract UID and password from the correct API response fields
        const uid = info.guest_account_info["com.garena.msdk.guest_uid"];
        const password = info.guest_account_info["com.garena.msdk.guest_password"];
